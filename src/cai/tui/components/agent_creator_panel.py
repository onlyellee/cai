...
class AgentCreatorPanel(Container):
    ...
    #tools-list > ListItem:last-child {
        border-bottom: none;
    }
    ...
    def compose(self) -> ComposeResult:
        ...
        with Container(id="agent-creator-overlay"):
            with Vertical(id="agent-creator-content"):
                # Header
                yield Static(f"🤖 {t('tui_create_agent')}", id="creator-header")
                ...
                with ScrollableContainer(id="creator-body-scroll"):
                    with Container(id="creator-body"):
                        ...
                        with Vertical(classes="form-section"):
                            yield Label(t('tui_agent_describe'), classes="form-label")
                            yield Static(t('tui_agent_describe_hint'), classes="hint-text")
                            yield TextArea(id="agent-description")
                        
                        # Tool selection section
                        with Vertical(id="tools-section", classes="form-section"):
                            yield Label(t('tui_select_tools'), classes="form-label")
                            yield Static(t('tui_click_toggle'), classes="hint-text")
                            yield ListView(
            ListItem(Label("☑ generic_linux_command - Execute commands"), name="generic_linux_command"),
                ...
                with Horizontal(id="creator-buttons"):
                    yield Button(t('tui_create_agent_btn'), id="btn-create", variant="success")
                    yield Button(t('tui_cancel'), id="btn-cancel", variant="error")

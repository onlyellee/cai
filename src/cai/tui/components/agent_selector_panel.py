        ...
        with Container(id="agent-selector-overlay"):
            with Vertical(id="agent-selector-content"):
                ...
                with Horizontal(id="selector-buttons"):
                    yield Button(t('tui_all'), id="btn-select-all", variant="primary")
                    yield Button(t('tui_none'), id="btn-select-none", variant="primary")
                    yield Button(t('tui_send'), id="btn-send", variant="success")

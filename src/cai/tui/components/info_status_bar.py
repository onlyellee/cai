...
# Import COST_TRACKER and context utilities
...
class InfoStatusBar(Container):
    ...
    def _update_info(self) -> None:
        ...
        try:
            ...
            # Get feature flags
            self.auto_compact = os.getenv("CAI_AUTO_COMPACT", "true").lower() == "true"
            self.memory_enabled = os.getenv("CAI_MEMORY", "false").lower() == "true"
            ...
            try:
                ...
                text = Text()
                text.append(t('tui_model_label'), style="dim #03fcb180")
                ...
                try:
                    agent_widget = self.query_one("#agent-model-info", Static)
                    agent_widget.update(f"{t('tui_model_label')}{self.model_name or 'default'}")
                except:
                    pass
